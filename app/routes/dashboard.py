...
def dashboard_summary(user_id: str) -> DashboardSummaryResponse:
...
def open_trades(user_id: str) -> list[OpenTradeItem]:
...
def closed_trades(user_id: str, limit: int = Query(default=100, ge=1, le=500)) -> list[ClosedTradeItem]:
...
def daily_pnl(user_id: str) -> DailyPnlResponse:
